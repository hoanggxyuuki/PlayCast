...
export const NewHomeScreen: React.FC<NewHomeScreenProps> = ({
    ...
    // Removed focusAnim to prevent native driver conflict
    ...
    const renderSmartInput = () => {
        ...
        // Use static border color based on focus state
        const borderColor = isInputFocused ? 'rgba(102, 126, 234, 0.8)' : 'rgba(102, 126, 234, 0.2)';
