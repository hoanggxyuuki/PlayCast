...
export const translations = {
  ...
  zh: {
    ...
    continueWatchingEnabled: '继续观看',
    defaultPlaybackSpeed: '默认播放速度',
    defaultQuality: '默认质量',
    autoPlayNextDesc: '自动播放队列中的下一个视频',
    continueWatchingDesc: '从上次停止的地方继续播放视频',
    defaultSpeedDesc: '默认视频播放速度',
    preferredQuality: '首选视频质量',

    playerFeatures: '播放器功能',
    pictureInPicture: '画中画',
    backgroundPlayback: '后台播放',
    pipDesc: '在浮动窗口中观看视频',
    backgroundDesc: '最小化应用时继续播放音频',

    gestureControls: '手势控制',
    enableGestures: '启用手势控制',
    volumeGesture: '音量手势',
    brightnessGesture: '亮度手势',
    doubleTapSeek: '双击跳转',
    gesturesDesc: '音量、亮度和快进的触摸手势',
    volumeDesc: '在右侧上下滑动调节音量',
    brightnessDesc: '在左侧上下滑动调节亮度',
    seekDesc: '双击时跳过的秒数',

    downloads: '下载',
    downloadQuality: '下载质量',
    downloadQualityDesc: '离线下载的质量',
    high: '高',
    medium: '中',
    low: '低',
  ...
  ja: {
    ...
    autoPlayNext: '次を自動再生',
    continueWatchingEnabled: '続きから再生',
    defaultPlaybackSpeed: 'デフォルト再生速度',
    defaultQuality: 'デフォルト画質',
    autoPlayNextDesc: 'キュー内の次の動画を自動再生',
    continueWatchingDesc: '前回停止した位置から動画を再開',
    defaultSpeedDesc: 'デフォルトの動画再生速度',
    preferredQuality: '優先する動画画質',

    playerFeatures: 'プレーヤー機能',
    pictureInPicture: 'ピクチャーインピクチャー',
    backgroundPlayback: 'バックグラウンド再生',
    pipDesc: 'フローティングウィンドウで動画を視聴',
    backgroundDesc: 'アプリを最小化したときも音声を続ける',

    gestureControls: 'ジェスチャーコントロール',
    enableGestures: 'ジェスチャーコントロールを有効化',
    volumeGesture: '音量ジェスチャー',
    brightnessGesture: '明るさジェスチャー',
    doubleTapSeek: 'ダブルタップシーク',
    gesturesDesc: '音量、明るさ、シークのタッチジェスチャー',
    volumeDesc: '右側を上下スワイプして音量調整',
    brightnessDesc: '左側を上下スワイプして明るさ調整',
    seekDesc: 'ダブルタップ時にスキップする秒数',

    downloads: 'ダウンロード',
    downloadQuality: 'ダウンロード画質',
    downloadQualityDesc: 'オフラインダウンロードの画質',
    high: '高',
    medium: '中',
    low: '低',
  ...
  ko: {
    ...
    continueWatchingEnabled: '이어서 보기',
    defaultPlaybackSpeed: '기본 재생 속도',
    defaultQuality: '기본 화질',
    autoPlayNextDesc: '대기열의 다음 동영상 자동 재생',
    continueWatchingDesc: '마지막으로 본 위치에서 동영상 계속',
    defaultSpeedDesc: '기본 동영상 재생 속도',
    preferredQuality: '선호하는 동영상 화질',

    playerFeatures: '플레이어 기능',
    pictureInPicture: '화면 속 화면',
    backgroundPlayback: '백그라운드 재생',
    pipDesc: '플로팅 창에서 동영상 시청',
    backgroundDesc: '앱 최소화 시 오디오 계속',

    gestureControls: '제스처 컨트롤',
    enableGestures: '제스처 컨트롤 활성화',
    volumeGesture: '볼륨 제스처',
    brightnessGesture: '밝기 제스처',
    doubleTapSeek: '더블 탭 탐색',
    gesturesDesc: '볼륨, 밝기 및 탐색을 위한 터치 제스처',
    volumeDesc: '오른쪽을 위아래로 스와이프하여 볼륨 조정',
    brightnessDesc: '왼쪽을 위아래로 스와이프하여 밝기 조정',
    seekDesc: '더블 탭 시 건너뛸 초',

    downloads: '다운로드',
    downloadQuality: '다운로드 화질',
    downloadQualityDesc: '오프라인 다운로드 화질',
    high: '높음',
    medium: '중간',
    low: '낮음',
